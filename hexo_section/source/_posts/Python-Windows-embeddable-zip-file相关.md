...
我将其解压并匹配到`C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\python.exe`路径。  

#### 编辑`python38._pth`文件
文件路径`C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\python38._pth`。取消注释`import site`。  
```
python37.zip
.
...
修改前：
```
C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64>python
...
C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64>
```

#### 安装pip
[get-pip.py](https://bootstrap.pypa.io/get-pip.py)。  
下载`get-pip.py`，并将其匹配到`C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\get-pip.py`，然后：  
```
C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64>DIR /B .\Scripts\.
系统找不到指定的文件。

C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64>python get-pip.py
...(略)...
Installing collected packages: pip, setuptools, wheel
  WARNING: The scripts pip.exe, pip3.7.exe and pip3.exe are installed in 'C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\Scripts' which is not on PATH.
  Consider adding this directory to PATH or, if you prefer to suppress this warning, use --no-warn-script-location.
  WARNING: The scripts easy_install-3.7.exe and easy_install.exe are installed in 'C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\Scripts' which is not on PATH.
  Consider adding this directory to PATH or, if you prefer to suppress this warning, use --no-warn-script-location.
  WARNING: The script wheel.exe is installed in 'C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64\Scripts' which is not on PATH.
  Consider adding this directory to PATH or, if you prefer to suppress this warning, use --no-warn-script-location.
...
```bat
REM 将其加入系统环境变量
SETX /M  PYTHON_ROOT_37  "C:\zx_folder\program_files_zx\python\python-3.7.9-embed-amd64"
REM 确保echo显示了正确的数据
ECHO %PYTHON_ROOT_37%
SETX /M  PATH  "%PATH%;%PYTHON_ROOT_37%;%PYTHON_ROOT_37%\Scripts;"
```
